...
a) initialiser R code and CSV abstract text for a single conference
b) initialiser R code to merge abstract texts from several conferences (aka "union" run)

Each of these also contains output files.
...
NB: if you are reading this from a public repository, there will be NO CSV files of abstract text due to concerns over breach of copyright.
